...
public class ConcreteCL3Alg
		implements
		CLAlg<IEvalEnvValue, IEvalEnvValueRetEnv, AbsValue<IEvalEnvValue>, IEvalBasic, IEvalEnvValueRetEnv, IEvalEnvValue> {

	
	public FunctionsAlg<IEvalEnvValue, IEvalEnvValue, AbsValue<IEvalEnvValue>> funInterpreter() {
		return new CompleteFunctions3Alg();
	}
	...
	public IEvalEnvValue function(IEvalEnvValue sm) {
		return (e,v) -> funInterpreter().abs(sm);
	}
	...
	public IEvalEnvValue apply(IEvalEnvValue e1, IEvalEnvValue e2) {
		return (e,v)-> funInterpreter().apply((AbsValue<IEvalEnvValue>) e1.eval(e, v), e2).eval(e, v);
	}
